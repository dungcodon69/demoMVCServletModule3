...
<div class="container">
    <div class="mt-3">
        <form class="row" method="post" action="/student?action=search">
            <div class="col-6">
                <input type="text" class="form-control" id="searchName" name="searchName" placeholder="Tìm kiếm học sinh...">
            </div>
    ...
    <table class="table table-hover">
        ...
        <c:forEach var="student" items="${students}" varStatus="status">
            <tr>
                ...
                <td>
                    <button class="btn btn-warning" onclick="window.location.href='/student?action=update&id=${student.id}'">Sửa</button>
